// From Definitely typed reason:
// It is from the currently unreleased version of signale that has full type defs.
// I needed this because didn't have the disable function. And the way the type are
// written i could not augment. we can remove this file once signale upgrades from 1.4.0
